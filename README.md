...
control the editor — spawn actors, run any of the 117 toolbelt tools, execute arbitrary Python.
...
**Available MCP commands:** ping, execute\_python, run\_tool (→ all 117 tools), list\_tools,
...
A dark-themed floating window opens with a left sidebar nav and 117 tools across 12 pages (including an About page).
...
|---|---|---|
| **Find any tool…** | Sidebar (top) | Global — searches all 117 tools across every category by name, description, or tag. Results show a category badge so you know where each tool lives. |
...
- Run any of the 117 tools by name
...
**What Claude can do:**
- Run any of the 117 toolbelt tools by name (`run_toolbelt_tool`)
...
- Every tool name, parameter, and usage example for all 117 tools
...
|---|---|---|
| Tool count | **117 tools, 10 modules** | Single-purpose scripts |
...
- **117 tools** across 11 categories: Materials, Procedural, Bulk Ops, Text, Assets, Verse, Project, Screenshot, Tags, MCP, API
